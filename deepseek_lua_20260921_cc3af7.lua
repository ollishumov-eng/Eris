...
task.wait(0.1)
setMenu(true)
if mobileToggleBtn then mobileToggleBtn.Text = "−" end
...
if not IS_MOBILE then
    UIS.InputBegan:Connect(function(i, gp)
        ...
        if i.KeyCode == Enum.KeyCode.RightShift then
            setMenu(not isOpen)
            if mobileToggleBtn then mobileToggleBtn.Text = isOpen and "−" or "+" end
        end
    end)
end
